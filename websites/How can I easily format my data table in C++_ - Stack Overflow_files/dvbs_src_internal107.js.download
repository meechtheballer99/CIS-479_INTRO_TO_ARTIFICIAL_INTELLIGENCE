...
navigator.platform);u&&(t+=u);v&&(t+="&useragent="+v);n&&(t+="&brid="+n.ID+"&brver="+n.version+"&bridua="+n.ID_UA);t+="&dup="+dv_GetParam(l,"dup");try{t+=dv_AppendIQPAParams(l)}catch(H){}(m=dv_GetParam(l,"turl"))&&(t+="&turl="+m);(m=dv_GetParam(l,"tagformat"))&&(t+="&tagformat="+m);dv_GetParam(l,"tagtype");t+=U();r=r?"&dvf=0":"";m=K("maple")?"&dvf=1":"";c=(window._dv_win.dv_config.verifyJSURL||"https://"+(window._dv_win.dv_config.bsAddress||"rtb"+d.dvregion+".doubleverify.com")+"/verify.js")+"?flvr=0&jsCallback="+
d.callbackName+"&jsTagObjCallback="+d.tagObjectCallbackName+"&num=6"+t+"&srcurlD="+c.depth+"&ssl="+d.ssl+r+m+"&refD="+x+d.tagIntegrityFlag+d.tagHasPassbackFlag+"&htmlmsging="+(g?"1":"0");(g=dv_GetDynamicParams(l,"dvp").join("&"))&&(c+="&"+g);(g=dv_GetDynamicParams(l,"dvpx").join("&"))&&(c+="&"+g);if(!1===h||k)c=c+("&dvp_isBodyExistOnLoad="+(h?"1":"0"))+("&dvp_isOnHead="+(k?"1":"0"));e="srcurl="+encodeURIComponent(e);(h=V())&&(e+="&ancChain="+encodeURIComponent(h));h=4E3;/MSIE (\d+\.\d+);/.test(navigator.userAgent)&&
7>=new Number(RegExp.$1)&&(h=2E3);if(k=dv_GetParam(l,"referrer"))k="&referrer="+k,c.length+k.length<=h&&(c+=k);(k=dv_GetParam(l,"prr"))&&(c+="&prr="+k);(k=dv_GetParam(l,"iframe"))&&(c+="&iframe="+k);(k=dv_GetParam(l,"gdpr"))&&(c+="&gdpr="+k);(k=dv_GetParam(l,"gdpr_consent"))&&(c+="&gdpr_consent="+k);q.length+A.length+c.length<=h&&(c+=A,e+=q);(q=W())&&(c+="&m1="+q);(q=X())&&0<q.f&&(c+="&bsig="+q.f,c+="&usig="+q.s);q=Y();0<q&&(c+="&hdsig="+q);navigator&&navigator.hardwareConcurrency&&(c+="&noc="+navigator.hardwareConcurrency);
c+=Z();q=aa();c+="&vavbkt="+q.vdcd;c+="&lvvn="+q.vdcv;""!=q.err&&(c+="&dvp_idcerr="+encodeURIComponent(q.err));"prerender"===window._dv_win.document.visibilityState&&(c+="&prndr=1");(l=dv_GetParam(l,"wrapperurl"))&&1E3>=l.length&&c.length+l.length<=h&&(c+="&wrapperurl="+l);c+="&"+b.getVersionParamName()+"="+b.getVersion();b="&eparams="+encodeURIComponent(C(e));c=c.length+b.length<=h?c+b:c+"&dvf=3";window.performance&&window.performance.mark&&window.performance.measure&&window.performance.getEntriesByName&&
(window.performance.mark("dv_create_req_end"),window.performance.measure("dv_creqte_req","dv_create_req_start","dv_create_req_end"),(b=window.performance.getEntriesByName("dv_creqte_req"))&&0<b.length&&(c+="&dvp_exetime="+b[0].duration.toFixed(2)));for(var y in d)d.hasOwnProperty(y)&&void 0!==d[y]&&-1<["number","string"].indexOf(typeof d[y])&&-1===["protocol","callbackName","dvregion"].indexOf(y.toLowerCase())&&!y.match(/^tag[A-Z]/)&&!(new RegExp("(\\?|&)"+y+"=","gi")).test(c)&&(c+=["&",y,"=",encodeURIComponent(d[y])].join(""));
return{isSev1:!1,url:c}}function U(){var b="";try{var d=window._dv_win.parent;b+="&chro="+(void 0===d.chrome?"0":"1");b+="&hist="+(d.history?d.history.length:"");b+="&winh="+d.innerHeight;b+="&winw="+d.innerWidth;b+="&wouh="+d.outerHeight;b+="&wouw="+d.outerWidth;d.screen&&(b+="&scah="+d.screen.availHeight,b+="&scaw="+d.screen.availWidth)}catch(e){}return b}function aa(){var b=[],d=function(b){c(b,null!=b.AZSD,9);c(b,b.location.hostname!=b.encodeURIComponent(b.location.hostname),10);c(b,null!=b.cascadeWindowInfo,
...
r+"');})()"}}}catch(m){e=window._dv_win.dv_config=window._dv_win.dv_config||{},e=dv_getDVBSErrAddress(e),c=[this.getVersionParamName(),this.getVersion()].join("="),e+=["/verify.js?flvr=0&ctx=818052&cmp=1619415&dvp_cert=3&num=6",c].join("&"),dv_SendErrorImp(e,[{dvp_jsErrMsg:"DvFrame: "+encodeURIComponent(m)}])}return!0};this.isApplicable=function(){return!0};this.onFailure=function(){};window.debugScript&&(window.CreateUrl=G);this.getVersionParamName=function(){return"ver"};this.getVersion=function(){return"155"}}
;
